...
public class HomeworkView {
    ...
    TextField idTemaField, descriereField, deadlineField, predataField, saptCurentaField;
    ...
    private VBox createLogo(){
        ...
        Image imageBack = new Image("view/backIcon.png");
        ...
        Image img = new Image("logos/02535d2f-2011-4427-90aa-66f3ce8ba8a2.png");
    ...
    private VBox createTextFieldsAndButtons(){
        ...
        Image imageAdd = new Image("logos/add.png");
        ...
        Image imagePostpone = new Image("logos/amana.png");
