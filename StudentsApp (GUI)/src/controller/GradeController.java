    ...
    private void handleSelectareTema(){
        ...
        if(object != null && saptCurenta != null){
            ...
            if(depunctare > 0){
                ...
                String motivare = textFieldSaptMotivate.getText().toString();
            ...
            /*
            if(!motivare.equals("")){
                Integer saptMotivate = Integer.parseInt(motivare.toString());
                depunctare = depunctare - saptMotivate;
                if(depunctare>2){
                    textAreaFeedback.setText("Tema nu mai poate fi predata !\n Veti fi notat cu nota 0.");
                }
                else{
                    textAreaFeedback.setText("Nu aveti alte penalizari ! ");
                }
