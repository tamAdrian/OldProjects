...
public class GradeService implements Observable<GradeChangeEvent> {
    ...
    public List<String> getAllHomeworkNumber(){
        ...
        Function<Nota,String> homeworkNumber = nota -> {return nota.getTema().toString();};
    ...
    public List<String>  getAllGroupNumber(){
        ...
        Function<Student, String> groupNumber = student -> {return student.getGrupa();};
    ...
    public List<NotaDTO> filterByHomeworkNumberAndGroup(String idTema, String numarGrupa){
        ...
        Predicate<NotaDTO> tema = notaDTO -> {return notaDTO.getNumeTema().toString().equals(idTema);};
    ...
    public Float averageForStudent(String name){
        ...
        List<NotaDTO> studentList =
                notaDTOList.stream()
                .filter(notaDTO -> {
                   return notaDTO.getNumeStudent().equals(name);})
                .collect(Collectors.toList());
